...
```bash
git clone git@github.com:um-programacion-ii/programacion-2-trabajo-practico-1-Emicora.git
cd programacion-2-trabajo-practico-1-Emicora
```
2. Compila el código: 
